  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        {/* Example one in which we are using imported image i.e: about 1 so we can use all the properties 
            like placeholder, quality etc 
        */}
        <Image
          src={about1}
          placeholder="blur"
      ...
      <div className="col-span-2 relative aspect-square">
        {/* This is 2nd example how we can place image in Image
            this example is for when we dont have the image locally
            but we are importing it from database.
            so we specified relative aspect-square in outer box
            and fill in Image, and we can't use properties like placeholder="blur"
            or quality={80} in this as the image is not imported
            so these are the difference b/w these two types.
        */}
        <Image
          src="/about-2.jpg"
          fill
